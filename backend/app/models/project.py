...
Used to persist project state server-side, avoiding large data payloads
being passed between API calls by the frontend.
"""
...
class ProjectManager:
    """Project manager — responsible for persisting and retrieving projects."""
    ...
    def _get_project_text_path(cls, project_id: str) -> str:
        """Get the path for the project's extracted text file."""
