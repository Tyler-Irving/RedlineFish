...
class EntityNode:
    ...
    def get_entity_type(self) -> Optional[str]:
        """Return the entity type (excludes the default Entity/Node labels)."""
...
class ZepEntityReader:
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        """
        Retrieve all nodes from the graph (paginated).
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        """
        Retrieve all edges from the graph (paginated).
    ...
    def filter_defined_entities(
        ...
        - If a node's Labels contain tags other than "Entity" and "Node", it matches — keep it.
        ...
        # Retrieve all edges (for subsequent relationship lookup)
        all_edges = self.get_all_edges(graph_id) if enrich_with_edges else []

        # Build a mapping from node UUID to node data
        node_map = {n["uuid"]: n for n in all_nodes}

        # Filter for qualifying entities
        filtered_entities = []
    ...
    def get_entity_with_context(
        ...
        try:
            ...
            # Retrieve all nodes for relationship lookup
            all_nodes = self.get_all_nodes(graph_id)
            node_map = {n["uuid"]: n for n in all_nodes}
