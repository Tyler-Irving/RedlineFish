...
class GraphBuilderService:
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This usage is required by the Zep SDK; the warning comes from dynamic class creation
    ...
    def add_text_batches(
        ...
        """Add text to the graph in batches; return the list of all episode UUIDs."""
        episode_uuids = []
        total_chunks = len(chunks)
