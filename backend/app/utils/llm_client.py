"""
LLM client wrapper.
Uniform OpenAI-format calls to any compatible provider.
"""
...
class LLMClient:
    ...
    def chat(
        ...
        Args:
            ...
            response_format: Response format hint (e.g. JSON mode)
        ...
        # Some models (e.g. MiniMax M2.5) include <think> reasoning blocks — strip them
    ...
    def chat_json(
        ...
        Returns:
            Parsed JSON object
        """
        # Try json_object response_format first; fall back if the provider
        # doesn't support it (e.g. Ollama with some models).
        try:
            response = self.chat(
                messages=messages,
                temperature=temperature,
