...
This script reads parameters from a config file to execute the simulation end-to-end automatically.
...
- Supports single-agent and batch-interview commands
...
class MaxTokensWarningFilter(logging.Filter):
    """Filter out camel-ai warnings about max_tokens (we intentionally omit max_tokens and let the model decide)."""
...
# Add the filter immediately at module load time, before any camel code executes
        ...
        try:
            ...
            for interview in interviews:
                ...
                try:
                    ...
                    print(f"  Warning: could not fetch Agent {agent_id}: {e}")
...
class TwitterSimulationRunner:
    ...
    def _create_model(self):
        ...
        Always reads from the project root .env file (highest priority):
        - LLM_API_KEY: API key
    ...
    def _get_active_agents_for_round(
        ...
        """
        Determine which agents are active this round based on the time and config.
        ...
        for cfg in agent_configs:
            ...
            # Check whether the agent is in its active window
