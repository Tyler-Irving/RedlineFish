          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A quick-chat version of the report generation agent, with access to 4 specialized tools and full simulation memory</div>
              </div>
...
const renderMarkdown = (content) => {
  ...
  // Remove <br> before paragraph open tags that follow block-level elements
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Fix numbering for non-consecutive ordered lists: keep counter incrementing when single-item <ol> elements are separated by paragraph content
